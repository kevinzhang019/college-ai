...
MAJOR_CATEGORIES = {
    'business': [
        'business', 'management', 'finance', 'accounting', 'marketing', 
        'economics', 'entrepreneurship', 'mba', 'commerce'
    ],
    'engineering': [
        'engineering', 'computer science', 'software', 'electrical', 
        'mechanical', 'civil', 'chemical', 'aerospace', 'biomedical'
    ],
    'healthcare': [
        'medicine', 'nursing', 'pharmacy', 'dentistry', 'veterinary', 
        'health', 'medical', 'therapy', 'rehabilitation'
    ],
    'liberal_arts': [
        'liberal arts', 'humanities', 'english', 'literature', 'history', 
        'philosophy', 'art', 'music', 'theater', 'languages'
    ],
    'science': [
        'biology', 'chemistry', 'physics', 'mathematics', 'statistics', 
        'environmental', 'geology', 'astronomy', 'research'
    ],
    'social_sciences': [
        'psychology', 'sociology', 'political science', 'anthropology', 
        'social work', 'criminal justice', 'international relations'
    ],
    'education': [
        'education', 'teaching', 'elementary', 'secondary', 'special education', 
...
def validate_config() -> bool:
    ...
    if not OPENAI_API_KEY:
        print("Warning: OPENAI_API_KEY is not set. Embedding functionality will not work.")
