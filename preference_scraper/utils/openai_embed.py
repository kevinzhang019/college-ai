...
def get_embedding(text: str, model: str = "text-embedding-ada-002", max_retries: int = 3) -> Optional[List[float]]:
    """
...
def get_embeddings_batch(texts: List[str], model: str = "text-embedding-ada-002", batch_size: int = 100) -> List[Optional[List[float]]]:
    """
