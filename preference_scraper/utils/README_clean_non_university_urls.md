...
```bash
python preference_scraper/utils/clean_non_university_urls.py
```
...
```bash
python preference_scraper/utils/clean_non_university_urls.py --dry-run
```
...
```bash
python preference_scraper/utils/clean_non_university_urls.py --college "Stanford University"
```
...
```bash
python preference_scraper/utils/clean_non_university_urls.py --analyze-only
```
...
```bash
python preference_scraper/utils/clean_non_university_urls.py --force-recheck
```
...
```bash
python preference_scraper/utils/clean_non_university_urls.py --force-permissions
```
