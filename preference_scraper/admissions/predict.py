...
from preference_scraper.admissions.models import School, NicheGrade
from preference_scraper.admissions.concordance import act_to_sat
from preference_scraper.admissions.feature_utils import (
...
class AdmissionsPredictor:
    ...
    def load(self):
        ...
        try:
            from preference_scraper.admissions.train import (
    ...
    def load(self):
        if not os.path.exists(MANIFEST_PATH):
            raise FileNotFoundError(
                ...
                "Run: python -m preference_scraper.admissions.train_bucketed"
            )
