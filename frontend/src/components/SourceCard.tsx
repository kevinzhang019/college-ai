...
export default function SourceCard({
  ...
  return (
    <motion.div
      ...
      className="card-hover border-l-4 border-l-forest-500 p-4 cursor-pointer"
    ...
    >
      <div className="min-w-0">
        ...
        <a
          ...
          className="text-sm font-medium text-slate-200 hover:text-forest-400 transition-colors line-clamp-1"
