...
- "Most complete" preference order:
  ...
  2) Newer crawled_at (string compare suffices for ISO-like timestamps)
  3) Higher id (stable tie-breaker)
...
def upsert_rows(collection: Collection, rows: List[dict]) -> None:
    ...
    # Note: content_sparse is auto-generated by BM25 function — do NOT include
    data = [ids, colleges, urls, url_canonicals, titles, contents, embeddings, page_types, crawled_ats]
    try:
